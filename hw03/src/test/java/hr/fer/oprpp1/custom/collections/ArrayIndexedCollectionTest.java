...
public class ArrayIndexedCollectionTest {
    ...
    public void testConstructorSize16() {
        assertEquals(16, new ArrayIndexedCollection<>().capacity);
    }

    @Test
    public void testConstructorGivenCapacity() {
        assertEquals(14, new ArrayIndexedCollection<>(14).capacity);
    }
    ...
    public void testConstructor2GivenCapacity() {
        ...
        assertEquals(14, new ArrayIndexedCollection<>(startCollection, 14).capacity);
    }
    ...
    public void testDoublingOfSize() {
        ...
        assertEquals(4, startCollection.capacity);
    }
